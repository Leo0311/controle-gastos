...
public class OrcamentoController {
    ...
    @PutMapping("/{id}")
    public Orcamento atualizar(
            @PathVariable Integer id, @RequestBody Orcamento orcamento, @AuthenticationPrincipal UsuarioPrincipal usuario) {
        return service.atualizar(id, orcamento, usuario.usuarioId());
    }
